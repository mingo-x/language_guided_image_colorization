...
if __name__ == '__main__':
    ...
    parser.add_argument('--deoldify', default=0, type=int, help='deoldify.')
    parser.add_argument('--batch_size', '-b', default=16, type=int, help='')
    parser.add_argument('--with_new_cap', '-c', default=0, type=int, help='')
    parser.add_argument('--gru', default=1, type=int, help='')
